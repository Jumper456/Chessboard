...
public class ChessBoard {
    ...
    * */
    ...
    private void setStandardBordOrder(){
        ...
        chessArray[0][3].setPiece(new ChessPieceQueen(ChessPiece.PieceType.QUEEN, ChessPiece.PieceColor.BLACK,this));
        ...
        chessArray[7][3].setPiece(new ChessPieceQueen(ChessPiece.PieceType.QUEEN, ChessPiece.PieceColor.WHITE,this));
